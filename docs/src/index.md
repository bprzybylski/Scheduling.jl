...
As of version 0.1.0 the package provides a limited amount of functionalities.
...
Moreover, as of version 0.1.0, a few algorithms for the $\text{P}||\text{C}_\text{max}$ problem are implemented:
